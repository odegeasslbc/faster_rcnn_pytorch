...
# hyper-parameters
# ------------
imdb_name = 'SeaLionSlicedTest'
img_set = '/media/bingchen/research2/sealion/test'


cfg_file = 'experiments/cfgs/faster_rcnn_sealion.yml'
...
save_name = 'faster_rcnn_10000_test'
max_per_image = 600
thresh = 0.05
vis = True
...
def test_net(name, net, imdb, max_per_image=300, thresh=0.05, vis=False):
	...
	print all_boxes
	    ...
	    cv2.imwrite('test_result_'+str(i)+'.jpg', im2show)
            cv2.waitKey(1)
